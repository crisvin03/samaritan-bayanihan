                        ...
                        <div class="flex items-center justify-between p-6 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="text-right">
                                    ...
                                    <div class="text-xs text-gray-500 mt-1">
                                        {{ $member->contributions_count ?? 0 }} contributions
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <a href="{{ route('treasurer.members.edit', $member) }}" class="p-2 text-green-600 hover:bg-green-100 rounded-lg transition-colors duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
