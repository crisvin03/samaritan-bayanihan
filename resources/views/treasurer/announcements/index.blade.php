            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-6">
                        ...
                        <div>
                            <h1 class="text-4xl font-bold text-white mb-2 animate-slide-in-left">Announcements</h1>
                            <p class="text-green-100 text-xl animate-slide-in-left-delayed">Manage announcements for {{ $barangay }}</p>
                            <div class="mt-4 flex items-center space-x-2">
                                <div class="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                                <span class="text-sm text-green-100">Announcement Center</span>
                            </div>
                        </div>
                    </div>
