            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-blue-100 text-lg">Stay updated with the latest news and information</p>
                        <div class="mt-4 flex items-center space-x-4">
                            <div class="flex items-center space-x-2">
                                <div class="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                                <span class="text-sm text-blue-100">Latest Updates</span>
                            </div>
        ...
        <div class="p-6">
                    ...
                    @foreach($announcements as $announcement)
                        <div class="bg-gray-50 rounded-xl p-6 border border-gray-200 hover:shadow-md transition-shadow duration-200">
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex-1">
                                    ...
                                    <div class="text-sm text-gray-600 mb-3">
                                        <span class="font-medium">Published:</span> {{ $announcement->created_at->format('M d, Y g:i A') }}
                                        <span class="mx-2">•</span>
                                        <span class="font-medium">By:</span> {{ $announcement->user->name }}
                                    </div>
                                </div>
                                <div class="flex items-center space-x-2 ml-4">
                                    <a href="{{ route('member.announcements.show', $announcement) }}" class="text-blue-600 hover:text-blue-900 transition-colors duration-200" title="Read More">
                            ...
                            <div class="prose max-w-none">
                                <p class="text-gray-700 leading-relaxed">{{ Str::limit($announcement->content, 200) }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <div class="text-gray-500 font-medium">No announcements available</div>
                    <div class="text-gray-400 text-sm mt-2">Check back later for updates</div>
                </div>
            @endif
        </div>
    </div>
