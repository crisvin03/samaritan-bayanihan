...
@section('content')
                    ...
                    <div>
                        ...
                        <div class="mt-4 flex items-center space-x-4">
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm text-blue-100">Latest Information</span>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Back Button -->
    <div class="mb-6">
        <a href="{{ route('member.announcements.index') }}" class="inline-flex items-center text-gray-600 hover:text-gray-900 transition-colors duration-200">
