...
@section('page-description', 'Create a new system announcement')
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-blue-100 text-lg">Create a new system announcement</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="target_audience" 
                            ...
                            <option value="treasurers" {{ old('target_audience') === 'treasurers' ? 'selected' : '' }}>Treasurers Only</option>
                            <option value="admins" {{ old('target_audience') === 'admins' ? 'selected' : '' }}>Administrators Only</option>
                        </select>
