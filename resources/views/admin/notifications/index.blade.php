...
@section('page-description', 'Stay updated with system activities and member actions')
...
@section('content')
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-6">
                        ...
                        <div>
                            <h1 class="text-4xl font-bold text-white mb-2 animate-slide-in-left">Admin Notifications</h1>
                            <p class="text-blue-100 text-xl animate-slide-in-left-delayed">Monitor system activities and member actions in real-time</p>
                        </div>
                    </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-8 py-6 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Monitor member activities and system events</p>
                    </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="flex-shrink-0">
                                <div class="w-12 h-12 bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl flex items-center justify-center group-hover:from-blue-200 group-hover:to-blue-300 transition-all duration-300">
                                    ...
                                    @elseif($notification->type === 'id_uploaded')
    ...
    @else
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden animate-slide-in-up">
            <div class="text-center py-20 px-8">
                ...
                <p class="text-lg text-gray-600 mb-8 max-w-md mx-auto">You have no new notifications. We'll notify you when there are new member activities or system events.</p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('admin.dashboard') }}" class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.members.index') }}" class="inline-flex items-center px-8 py-4 bg-white border-2 border-gray-300 hover:border-blue-500 text-gray-700 hover:text-blue-600 font-semibold rounded-xl transition-all duration-300 shadow-sm hover:shadow-md">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <script>
        ...
        // Listen for ID document uploads
        ...
        function getIconClass(type) {
            switch(type) {
                case 'new_member':
                    return '<svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>';
                case 'id_uploaded':
