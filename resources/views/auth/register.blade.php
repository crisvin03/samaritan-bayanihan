            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-7" id="registerForm" novalidate>
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <option value="A. Bonifacio" {{ old('barangay') == 'A. Bonifacio' ? 'selected' : '' }}>A. Bonifacio</option>
                        <option value="Abad Santos" {{ old('barangay') == 'Abad Santos' ? 'selected' : '' }}>Abad Santos</option>
                        <option value="Aguinaldo" {{ old('barangay') == 'Aguinaldo' ? 'selected' : '' }}>Aguinaldo</option>
                        ...
                        <option value="Benigno S. Aquino" {{ old('barangay') == 'Benigno S. Aquino' ? 'selected' : '' }}>Benigno S. Aquino</option>
                        ...
                        <option value="E. Quirino" {{ old('barangay') == 'E. Quirino' ? 'selected' : '' }}>E. Quirino</option>
                        <option value="Fabrica" {{ old('barangay') == 'Fabrica' ? 'selected' : '' }}>Fabrica</option>
                        <option value="G. del Pilar" {{ old('barangay') == 'G. del Pilar' ? 'selected' : '' }}>G. del Pilar</option>
                        ...
                        <option value="J. Gerona" {{ old('barangay') == 'J. Gerona' ? 'selected' : '' }}>J. Gerona</option>
                        <option value="J. P. Laurel" {{ old('barangay') == 'J. P. Laurel' ? 'selected' : '' }}>J. P. Laurel</option>
                        ...
                        <option value="Libertad" {{ old('barangay') == 'Libertad' ? 'selected' : '' }}>Libertad</option>
                        <option value="M. Roxas" {{ old('barangay') == 'M. Roxas' ? 'selected' : '' }}>M. Roxas</option>
                        <option value="Magsaysay" {{ old('barangay') == 'Magsaysay' ? 'selected' : '' }}>Magsaysay</option>
                        <option value="Managanaga" {{ old('barangay') == 'Managanaga' ? 'selected' : '' }}>Managanaga</option>
                        ...
                        <option value="N. Roque" {{ old('barangay') == 'N. Roque' ? 'selected' : '' }}>N. Roque</option>
                        ...
                        <option value="Osmeña" {{ old('barangay') == 'Osmeña' ? 'selected' : '' }}>Osmeña</option>
                        ...
                        <option value="Quezon" {{ old('barangay') == 'Quezon' ? 'selected' : '' }}>Quezon</option>
                        <option value="R. Gerona" {{ old('barangay') == 'R. Gerona' ? 'selected' : '' }}>R. Gerona</option>
                        ...
                        <option value="San Francisco" {{ old('barangay') == 'San Francisco' ? 'selected' : '' }}>San Francisco</option>
                        ...
                        <option value="Santa Teresita" {{ old('barangay') == 'Santa Teresita' ? 'selected' : '' }}>Santa Teresita</option>
                        ...
                        <option value="Zone I (Poblacion)" {{ old('barangay') == 'Zone I (Poblacion)' ? 'selected' : '' }}>Zone I (Poblacion)</option>
                        <option value="Zone II (Poblacion)" {{ old('barangay') == 'Zone II (Poblacion)' ? 'selected' : '' }}>Zone II (Poblacion)</option>
                        <option value="Zone III (Poblacion)" {{ old('barangay') == 'Zone III (Poblacion)' ? 'selected' : '' }}>Zone III (Poblacion)</option>
                        <option value="Zone IV (Poblacion)" {{ old('barangay') == 'Zone IV (Poblacion)' ? 'selected' : '' }}>Zone IV (Poblacion)</option>
                        <option value="Zone V (Poblacion)" {{ old('barangay') == 'Zone V (Poblacion)' ? 'selected' : '' }}>Zone V (Poblacion)</option>
                        <option value="Zone VI (Poblacion)" {{ old('barangay') == 'Zone VI (Poblacion)' ? 'selected' : '' }}>Zone VI (Poblacion)</option>
                        <option value="Zone VII (Poblacion)" {{ old('barangay') == 'Zone VII (Poblacion)' ? 'selected' : '' }}>Zone VII (Poblacion)</option>
                        <option value="Zone VIII (Poblacion)" {{ old('barangay') == 'Zone VIII (Poblacion)' ? 'selected' : '' }}>Zone VIII (Poblacion)</option>
                        </select>
